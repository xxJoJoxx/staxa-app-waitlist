...
import { ArrowRight, CheckCircle, Cpu, Layers, Loader2, Zap, Database, Code, Server, Globe, ChevronLeft, ChevronRight, Github, GitBranch, Box, Network, Activity, Shield, LineChart, BarChart, Settings, LayoutGrid, Container, Package, Terminal, TestTube, Radio, GitCompare, GitMerge, X, AlertTriangle } from "lucide-react"
            ...
            <div className="flex flex-col md:grid md:grid-cols-[1fr_400px] md:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Link href="#waitlist">
                    <Button 
                      className="inline-flex h-10 items-center justify-center rounded-md px-8 text-sm font-medium text-white shadow hover:shadow-lg focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 gradient-btn"
                    >
                      Join the Waitlist
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  ...
                  Get early access to all our advanced features including the infrastructure visualization dashboard, 
                  AI-powered optimization, local development environments, and more.
                </p>
              </div>
